...
function logDomainRequest($domains) {
    try {
        $logFile = 'domain_requests.log';
        $timestamp = date('Y-m-d H:i:s');
        $logEntry = $timestamp . " - Domains requested:\n";
        
        foreach ($domains as $domain) {
            $logEntry .= "- " . trim($domain) . "\n";
        }
        $logEntry .= "----------------------------------------\n";
        ...
        error_log("Error logging domain request: " . $e->getMessage());
        return false;
    }
}
